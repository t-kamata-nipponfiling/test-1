        ...
        _showTimepicker: function (input) {
            ...
            if ( ! inst.inline ) {
                ...
                if ($.effects && $.effects[showAnim]) {
                    ...
                    inst.tpDiv[showAnim]((showAnim ? duration : null), postProcess);
                }
            ...
            if (showHours) {
                ...
                for (row = 1; row <= rows; row++) {
                    ...
                    if (row == amFirstRow && showPeriodLabels) {
                        html += '<th rowspan="' + amRows.toString() + '" class="periods hour-am" scope="row">' + amPmText[0] + '</th>';
                    }
                    // PM
                    if (row == pmFirstRow && showPeriodLabels) {
                        html += '<th rowspan="' + pmRows.toString() + '" class="periods hour-pm" scope="row">' + amPmText[1] + '</th>';
                    }
